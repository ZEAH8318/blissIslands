(function($, window) {
    ...
    $(function() {
                ...
                if (select.data('selectBox')) {
                    ...
                    var opt = {
                        ...
                        select: function(event, ui) {
                            ...
                            //접근성 추가 : 포커스 이동
                            select.closest(".select-wrap, .selectWrap").find('.ui-selectmenu-text').eq(0).attr('tabindex', 0).focus();
                            ...
                            if (spanCnt > 1) {
                                ...
                                select.closest(".select-wrap, .selectWrap").find('.ui-selectmenu-text').html(copySpan);
                            }
        ...
        $(function() {
            selectMenu.init();
            $(document).find(".select-wrap, .selectWrap").each(function() {
